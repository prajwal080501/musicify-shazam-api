    ...
    <div className="max-w-[95vw] h-fit mx-auto bg-gray-100 rounded-md shadow-lg pb-3 mb-5 ">
      ...
      <div className='grid  grid-cols-2  mb-3 place-items-center h-fit md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5'>
        {charts.map(chart => (
          ...
          <div className=' even:bg-green-500 rounded-lg shadow-m hover:opacity-75 hover:scale-105 duration-300 cursor-pointer ease odd:bg-gradient-to-b from-indigo-500 via-purple-600 to-pink-400   text-white mb-3 p-4 w-60 h-56'>
